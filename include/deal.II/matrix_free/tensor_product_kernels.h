...
namespace internal
{
    ...
    for (int i2 = 0, i = 0; i2 < (dim > 2 ? n_shapes : 1); ++i2)
      {
        ...
        if (n_shapes == 2)
          inner_result = do_interpolate_xy<dim, 2, Number2>(
            values, renumber, shapes, n_shapes, i);
        else if (n_shapes == 3)
          inner_result = do_interpolate_xy<dim, 3, Number2>(
            values, renumber, shapes, n_shapes, i);
        else if (n_shapes == 4)
          inner_result = do_interpolate_xy<dim, 4, Number2>(
            values, renumber, shapes, n_shapes, i);
        else if (n_shapes == 5)
          inner_result = do_interpolate_xy<dim, 5, Number2>(
            values, renumber, shapes, n_shapes, i);
        else if (n_shapes == 6)
          inner_result = do_interpolate_xy<dim, 6, Number2>(
            values, renumber, shapes, n_shapes, i);
        else
          inner_result = do_interpolate_xy<dim, -1, Number2>(
            values, renumber, shapes, n_shapes, i);
        if (dim == 3)
          {
  ...
  do_test_xy(AlignedVector<Number2> &                    values,
             const std::vector<unsigned int> &           renumber,
    ...
    for (int i1 = 0; i1 < (dim > 1 ? n_shapes : 1); ++i1)
      {
        const Number2 test_value_y =
          dim > 1 ?
            (test_value_z * shapes[i1][0][1] + test_grad_y * shapes[i1][1][1]) :
            test_value_z;
    ...
    for (int i2 = 0, i = 0; i2 < (dim > 2 ? n_shapes : 1); ++i2)
      {
        ...
        if (n_shapes == 2)
          do_test_xy<dim, 2, Number2, Number>(values,
                                              renumber,
                                              shapes,
                                              test_grad_x,
                                              test_grad_y,
          ...
          do_test_xy<dim, 3, Number2, Number>(values,
                                              renumber,
                                              shapes,
                                              test_grad_x,
                                              test_grad_y,
          ...
          do_test_xy<dim, 4, Number2, Number>(values,
                                              renumber,
                                              shapes,
                                              test_grad_x,
                                              test_grad_y,
          ...
          do_test_xy<dim, 5, Number2, Number>(values,
                                              renumber,
                                              shapes,
                                              test_grad_x,
                                              test_grad_y,
          ...
          do_test_xy<dim, 6, Number2, Number>(values,
                                              renumber,
                                              shapes,
                                              test_grad_x,
                                              test_grad_y,
          ...
          do_test_xy<dim, -1, Number2, Number>(values,
                                               renumber,
                                               shapes,
                                               test_grad_x,
                                               test_grad_y,
